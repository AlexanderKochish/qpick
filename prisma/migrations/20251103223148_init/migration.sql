...
-- DropForeignKey
ALTER TABLE "public"."FavoriteItem" DROP CONSTRAINT "FavoriteItem_favoriteId_fkey";

-- DropForeignKey
ALTER TABLE "public"."FavoriteItem" DROP CONSTRAINT "FavoriteItem_productId_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."Product" DROP CONSTRAINT "Product_productModelId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Rating" DROP CONSTRAINT "Rating_authorId_fkey";
...
-- DropTable
DROP TABLE "public"."FavoriteItem";
...
-- DropTable
DROP TABLE "public"."ProductModel";
...
-- CreateIndex
CREATE UNIQUE INDEX "carts_visitorId_key" ON "carts"("visitorId");

-- CreateIndex
CREATE UNIQUE INDEX "cart_items_cartId_productId_key" ON "cart_items"("cartId", "productId");

-- CreateIndex
CREATE UNIQUE INDEX "favorite_items_productId_favoriteId_key" ON "favorite_items"("productId", "favoriteId");
...
-- AddForeignKey
ALTER TABLE "favorite_items" ADD CONSTRAINT "favorite_items_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "favorite_items" ADD CONSTRAINT "favorite_items_favoriteId_fkey" FOREIGN KEY ("favoriteId") REFERENCES "favorites"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
